...
//     const [itemsPerPage, setItemsPerPage] = useState(window.innerWidth > 578 ? 3 : 1.5);

//     useEffect(() => {
//         const handleResize = () => {
//             setItemsPerPage(window.innerWidth > 578 ? 3: 1);
//         };
...
//                         width: `${(reviews.length / itemsPerPage) * 100}%` // Breite des Sliders anpassen
//                     }}>
